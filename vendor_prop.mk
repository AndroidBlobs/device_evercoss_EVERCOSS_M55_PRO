PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    persist.sys.defaulttimezone=Asia/Jakarta \
    ...
    ro.config.default_message0=EVERCOSS_NOTIF.mp3 \
    ro.config.default_message1=EVERCOSS_NOTIF.mp3 \
    ro.config.low_ram=true \
    ro.config.message_sound=EVERCOSS_NOTIF.mp3 \
    ro.config.notification_sound=EVERCOSS_NOTIF.mp3 \
    ro.config.ringtone0=EVERCOSS_RINGTONE.mp3 \
    ro.config.ringtone1=EVERCOSS_RINGTONE.mp3 \
